...
const S3 =
  "https://efg-final.s3.eu-north-1.amazonaws.com/speakers/cyber-first-kenya";
const EVENT_DATE = new Date("2026-06-15T08:00:00+03:00");
...
// ─── Data ────────────────────────────────────────────────────────────────────
// Confirmed speakers for Kenya 2026
const SPEAKERS = [
  {
    name: "Danstan Akwiri",
    title: "VP Cybersecurity",
    org: "Cyberpro Global",
    photo: `${S3}/placeholder-speaker.jpg`,
  },
  {
    name: "Dr. James Kimuyu",
    title: "Director",
    org: "NC4",
    photo: `${S3}/placeholder-speaker.jpg`,
  },
  ...
  {
    name: "George Kisaka",
    title: "Co-founder & CEO | Vice President",
...
const FOCUS_AREAS = [
  ...
  },
  {
    ...
    desc: "Ensuring cybersecurity resilience across smart infrastructure, cloud transformation, and emerging digital technologies aligned with Kenya Vision 2030.",
    icon: "M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z",
    wide: true,
  },
  {
    title: "Regulatory Compliance & Risk Frameworks",
    desc: "Navigating Kenya's evolving regulatory landscape including CBK's Cyber & Operational Resilience Framework (CORF), GCC mandates, and global standards.",
...
const SPONSORS = {
  ...
  supporting: [
    { name: "Kenya College of Science & Technology", logo: null },
    { name: "Arab Open University", logo: null },
    { name: "German Business Council Kenya", logo: null },
...
const AGENDA = [
  ...
  { time: "09:20 – 10:10", title: "Panel Discussion 1 – Critical Infrastructure Security", subtitle: "Safeguarding National Critical Infrastructure & Neutralizing Advanced Threats", type: "panel" as const },
  ...
  { time: "10:50 – 11:35", title: "Panel Discussion 2 – AI & Threat Intelligence", subtitle: "Integrating Artificial Intelligence & Next-Generation Threat Intelligence", type: "panel" as const },
...
const AWARDS_DATA = [
  {
    ...
    desc: "Recognising an individual demonstrating exceptional strategic vision in advancing Kenya\u2019s cybersecurity posture.",
    ...
    >
      ...
      <div className="cfk-hero-content">
        ...
        >
          ...
          >
            Beyond Firewalls — Strategic Cyber Defense for Kenya&apos;s Digital Age. The premier summit for CISOs, government leaders, and enterprise security executives.
          </motion.p>
      ...
      {/* ═══ BOTTOM BAR: 1st Edition badge + Countdown ═══ */}
      <motion.div
...
function MarketContext() {
  ...
  const stats = [
    { value: 29.9, suffix: "B", label: "KES Cybercrime Losses", note: "Economic impact in 2025", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z", badge: "2025", highlight: true },
    { value: 247, suffix: "%", label: "Annual Threat Increase", note: "Cybersecurity incidents in 2025", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", badge: "Critical" },
    { value: 96, suffix: "%", label: "Talent Shortage", note: "Only 1,700 of 40,000 experts needed", icon: "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75", badge: "Gap" },
    { value: 842, suffix: "M+", label: "Threats Detected", note: "July-September 2025", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", badge: "Q3" },
  ];
    ...
    >
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 clamp(20px,5vw,80px)", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            <span style={{ color: "white" }}>Kenya&apos;s Cybersecurity Market</span>
            <br />
            <span
    ...
    <div ref={ref} style={{ position: "relative", height: "55vh", overflow: "hidden", background: "#020508" }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          >
            Where Kenya&apos;s cyber leaders shape the future of national security.
          </p>
        </motion.div>
      </div>
    </div>
        ...
        >
          <div>
            ...
            <p style={{ fontFamily: "var(--font-outfit)", fontSize: 14, color: "#484848", margin: 0 }}>
              Kenya&apos;s most senior cybersecurity and technology leaders
            </p>
          </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 clamp(20px, 4vw, 60px)", position: "relative" }}>
        ...
        >
          ...
          <p style={{ fontFamily: "var(--font-outfit)", fontSize: 15, fontWeight: 400, color: "rgba(255,255,255,0.5)", marginTop: 12, maxWidth: 500, margin: "12px auto 0" }}>
            Join Kenya&apos;s premier cybersecurity summit as a founding partner
          </p>
        </motion.div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 clamp(20px, 4vw, 60px)", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <p style={{ fontFamily: "var(--font-outfit)", fontWeight: 300, fontSize: 15, color: "rgba(255,255,255,0.45)", maxWidth: 500, margin: "14px auto 0", lineHeight: 1.6 }}>
            Industry leaders shaping the summit agenda and driving cybersecurity excellence across Kenya.
          </p>
        </motion.div>
        ...
        <div className="cfk-awards-top" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20 }}>
          ...
          >
            ...
            <h3 style={{
              ...
              Recognising Visionary Leadership &amp; Cybersecurity Innovation Across Kenya
            </h3>
            <p style={{
              ...
              The Cyber First Awards 2026 celebrate outstanding individuals and organisations driving cybersecurity leadership, innovation, and resilience across Kenya&rsquo;s public and private sectors. These awards honour pioneers strengthening national cyber defence, securing digital transformation, and building trusted digital ecosystems.
            </p>
          </motion.div>
        ...
        <div style={{ position: "relative", borderRadius: 20, overflow: "hidden" }}>
          ...
          >
            ...
            <p style={{
              ...
              Cyber First Awards recognise organisations and leaders demonstrating exceptional contributions to Kenya&rsquo;s cybersecurity ecosystem.
            </p>
        ...
        >
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                Join 350+ CISOs, government security leaders, and technology experts. June 2026 at Nairobi, Kenya.
              </p>
...
function Venue() {
  ...
  const venueDetails = [
    ...
    { icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", label: "Date", value: "June 2026" },
        ...
        >
          ...
          <div className="cfk-venue-inner" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(24px,3vw,40px)", alignItems: "center" }}>
            ...
            <div>
              ...
              >
                Kenya&apos;s premier beachfront conference destination — hosting the region&apos;s
                leading cybersecurity gathering for the third consecutive year.
              </p>
              <a
                href="https://maps.google.com/?q=Jumeirah+Messilah+Beach+Hotel+Kenya"
                target="_blank"
...
const REG_TABS = [
  {
    ...
    fields: [
      ...
      { name: "phone", label: "Phone Number", type: "tel", placeholder: "+254 xxx xxx xxxx" },
  ...
  },
  {
    ...
    description:
      "Put your brand in the room with East Africa\u2019s top CISOs and security decision-makers.",
    perks: [
      { icon: "layers", text: "Boardroom hosting & keynote slots" },
      { icon: "target", text: "Qualified lead generation" },
      { icon: "eye", text: "Premium brand visibility across East Africa" },
    ],
...
function RegistrationSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await submitForm({
      ...
      event_name: "Cyber First Kenya 2026",
      metadata: meta,
    });
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2" style={{ marginTop: 12 }}>
                {["1st Edition", "June 15, 2026", "Nairobi, Kenya"].map(
                  (item, index, arr) => (
