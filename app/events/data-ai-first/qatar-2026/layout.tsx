...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: BASE_URL }, { name: "Events", url: `${BASE_URL}/events` }, { name: "Data & AI First", url: `${BASE_URL}/events/data-ai-first` }, { name: "Qatar 2026", url: PAGE_URL }]} />
