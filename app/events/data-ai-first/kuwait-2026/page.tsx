          ...
          {AGENDA_FILTERS.map((f) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  if (!isActive) {
                    e.currentTarget.style.background = `${E}15`;
                    e.currentTarget.style.borderColor = `${E}30`;
            ...
            return (
              ...
              >
                <button
                  ...
                  style={{ padding: "18px 20px", background: "none", border: "none", cursor: "pointer", transition: "background 0.3s ease" }}
                  onMouseEnter={(e) => { if (!isOpen) e.currentTarget.style.background = `${E}06`; }}
    ...
    <form onSubmit={handleSubmit} style={{ marginTop: 24 }}>
      ...
      <div style={{ marginBottom: 12 }}>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <input
            ...
            maxLength={appSelectedCountry.length}
            style={{ ...inputStyle("phone"), flex: 1 }}
          />
        </div>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          if (!loading) {
            e.currentTarget.style.transform = "translateY(-2px)";
            e.currentTarget.style.boxShadow = "0 10px 40px rgba(196,163,74,0.5)";
          }
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = "translateY(0)";
          e.currentTarget.style.boxShadow = "0 6px 28px rgba(196,163,74,0.35)";
        }}
      >
        {loading ? (
          <>
    ...
    <form onSubmit={handleSubmit} style={{ marginTop: 20 }}>
      ...
      <div style={{ marginBottom: 10 }}>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <input
            ...
            maxLength={partnerSelectedCountry.length}
            style={{ ...inputStyle("phone"), flex: 1 }}
          />
        </div>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          if (!loading) {
            e.currentTarget.style.transform = "translateY(-2px)";
            e.currentTarget.style.boxShadow = `0 10px 40px ${E}40`;
          }
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = "translateY(0)";
          e.currentTarget.style.boxShadow = `0 4px 20px ${E}25`;
        }}
      >
        {loading ? (
          <>
  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        .daik-form-wrapper #get-involved > .absolute {
          display: none;
        }

        /* Glass morphism on form card */
        .daik-form-wrapper .inquiry-split > div:last-child {
          ...
          border: 1px solid rgba(15, 115, 94, 0.15) !important;
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        ...
                        style={{ fontFamily: "var(--font-outfit)", fontSize: 12, color: GOLD, textDecoration: "none", transition: "opacity 0.3s ease" }}
