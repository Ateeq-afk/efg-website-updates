...
const categories: Category[] = [
  ...
  },
  {
    ...
    heroImage: `${CFK}/cyber21-04-500.jpg`,
    images: [
      { src: `${CFK}/cyber21-04-500.jpg`, caption: "Cyber First Kuwait — exhibition hall aerial" },
      { src: `${CFK}/cyber21-04-400.jpg`, caption: "ManageEngine booth — active networking" },
      { src: `${CFK}/cyber21-04-150.jpg`, caption: "Google Cloud Security — partner engagement" },
      { src: `${GOOD}/4N8A9900.JPG`, caption: "Bureau Veritas — sponsor conversations" },
    ],
  },
  {
    id: "audience",
  ...
  },
  {
    ...
    heroImage: `${GOOD}/4N8A0330.JPG`,
    images: [
      { src: `${GOOD}/4N8A0330.JPG`, caption: "Cybersecurity Leader of the Year — UAE & MENA" },
      { src: `${GOOD}/4N8A0200.JPG`, caption: "Award presentation — Cyber First UAE" },
      { src: `${GOOD}/4N8A0107.JPG`, caption: "Trophy ceremony — executive recognition" },
      { src: `${CFK}/cyber21-04-450.jpg`, caption: "Kuwait officials — VIP recognition" },
    ],
  },
];
